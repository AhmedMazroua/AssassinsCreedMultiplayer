...
public class AssassinManager {
    ...
    public void printKillRing() {
        ...
        while (curr != null) {
            if (curr.next == null) {
                ...
                curr = curr.next;
                // Stop when we've gone full circle
                if (curr == killRingHead) {
                    break;
                }
            }
        }
    ...
    public void printGraveyard() {
        ...
        while (current != null) {
            System.out.println("    " + current.name + " was killed by " + current.killer); // Print graveyard kill
                                                                                            // status to console
    ...
    public void kill(String name) {
        ...
        if (!killRingContains(name)) {
            throw new IllegalArgumentException("Name is not in the kill ring."); // If the name is not present in the
                                                                                 // killring return string response
        }
        ...
        if (deceased != null) {
            // Find who was stalking the deceased (their killer)
            AssassinNode killer = killRingHead;
            if (killer != null) {
                while (killer.next != null && !killer.next.name.equalsIgnoreCase(name)) {
                    killer = killer.next;
                }
